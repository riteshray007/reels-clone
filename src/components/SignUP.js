        ...
        <div className='signupwrapper' >
            <div className='signupcard' >
                <Card sx={{ maxWidth: 345 }}>
                    ...
                    <Button
                        style={{
                            width: '90%', textTransform: 'none',
                            fontFamily: 'Oswald , sans-serif', fontWeight: '30px'
                        }}
                        color="secondary"
                        component='label' >
                    ...
                    <Button onClick={() => handleclick()}
                        ...
                        style={{
                            ...
                            textTransform: 'none', marginBottom: '2.5rem'
                        }}
            ...
            <div className='secdiv' >
                <Card className='secondcard' sx={{ maxWidth: 345 }} >
                    ...
                    >Have an account?
                        <Button vareint='text'
                            sx={{
                                padding: '0rem', margin: '0px',
                                textTransform: 'none'
                            }} >
                            <Link to='/login' style={{ textDecoration: 'none' }}> Log in </Link>  </Button></Typography>
                </Card>
            </div>
        </div>
    );
